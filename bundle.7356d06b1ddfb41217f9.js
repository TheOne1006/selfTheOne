 ...
 */
!function(e,n){"use strict"; true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function(t){return n(t,e,e.document,e.Math)}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
h={};g()}};"function"==="function"&&__webpack_require__(25)&&!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function(){return Y}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js??ref--1-1!./jquery.fullpage.min.css", function() {
			var newContent = require("!!../../css-loader/index.js??ref--1-1!./jquery.fullpage.min.css");
...
module.exports = __webpack_require__.p + "assets/svgs/tree/tree.svg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fullpage_js_dist_jquery_fullpage_min_css__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fullpage_js_dist_jquery_fullpage_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_fullpage_js_dist_jquery_fullpage_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_google_code_prettify_bin_prettify_min__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_google_code_prettify_bin_prettify_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_google_code_prettify_bin_prettify_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fullpage_js_dist_jquery_fullpage_min__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_fullpage_js_dist_jquery_fullpage_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_fullpage_js_dist_jquery_fullpage_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vivus_dist_vivus__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vivus_dist_vivus___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vivus_dist_vivus__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_styles_index_scss__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_styles_index_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__assets_styles_index_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_svgs_tree_tree_svg__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_svgs_tree_tree_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__assets_svgs_tree_tree_svg__);
/**
...
// START YOUR APP HERE
// ================================
$(window.document).ready(()=>{const animateHooks={// 展示
bottom:'moveUp',top:'moveDown',left:'moveRight',right:'moveLeft',topLeft:'moveDownRight',bottomLeft:'moveUpRight',topRight:'moveDownLeft',bottomRight:'moveUpLeft'};// 是否为移动设备
const isMobile=window.navigator.userAgent.match(/mobile/i);// 缓存图片数据
const svgImgs={sectionAll:$('#sectionAll .svgimg'),sectionInfo:$('#sectionInfo .svgimg'),welcomeTop:$('.welcome-top'),welcomeBottom:$('.welcome-bottom')};// 初始化
svgImgs.sectionAll.addClass(function addClass(){return animateHooks[$(this).data('animate')];});window.prettyPrint();const vivusTheOne=new __WEBPACK_IMPORTED_MODULE_3_vivus_dist_vivus___default.a('vivusTheOne',{type:'scenario-sync',duration:10,start:'autostart',dashGap:10,forceRender:false});$('#vivusTheOne').click(()=>{vivusTheOne.reset().play();});let vivusTree;function treePlay(){if(!vivusTree){vivusTree=new __WEBPACK_IMPORTED_MODULE_3_vivus_dist_vivus___default.a('tree',{type:'scenario',file:__WEBPACK_IMPORTED_MODULE_5__assets_svgs_tree_tree_svg___default.a});// hack 加载进度
setTimeout(()=>{vivusTree.reset().play();},2000);}else{vivusTree.reset().play();}}// fullpage
$('#fullpage').fullpage({// 在复杂情况下还是会失效
// sectionsColor: ['#563d7c' ,'#5bc0de','#5cb85c','#f0ad4e','#d9534f'],
anchors:['all','page2','page3','page4'],// 移动设备启用css3
css3:isMobile,controlArrows:!isMobile,verticalCentered:false,animateAnchor:true,recordHistory:true,afterRender:()=>{// 渲染完成
setTimeout(()=>{svgImgs.sectionAll.removeClass(function removeClass(){return animateHooks[$(this).data('animate')];});},500);},onLeave:(index,nextIndex)=>{switch(index){case 1:$('#staticLogo').addClass('active');svgImgs.sectionAll.addClass(function addClass(){return animateHooks[$(this).data('animate')];});break;case 2:if(!isMobile){svgImgs.sectionInfo.removeClass('flashAndtada');}break;case 3:svgImgs.welcomeBottom.removeClass('welcome-animate-bottom');svgImgs.welcomeTop.removeClass('welcome-animate-top');break;default:// treePlay('rewind');
break;}switch(nextIndex){case 1:$('#staticLogo').removeClass('active');svgImgs.sectionAll.removeClass(function removeClass(){return animateHooks[$(this).data('animate')];});break;case 2:if(!isMobile){svgImgs.sectionInfo.addClass('flashAndtada');}break;case 3:setTimeout(()=>{svgImgs.welcomeBottom.addClass('welcome-animate-bottom');svgImgs.welcomeTop.addClass('welcome-animate-top');},800);break;case 4:$('#tree').show();treePlay();break;default:break;}}});});
...
// module
exports.push([module.i, "@font-face{font-family:FontAwesome;src:url(" + __webpack_require__(17) + ");src:url(" + __webpack_require__(16) + "?#iefix&v=4.3.0) format(\"embedded-opentype\"),url(" + __webpack_require__(22) + ") format(\"woff2\"),url(" + __webpack_require__(21) + ") format(\"woff\"),url(" + __webpack_require__(23) + ") format(\"truetype\"),url(" + __webpack_require__(24) + "#fontawesomeregular) format(\"svg\");font-weight:400;font-style:normal}[class*=am-icon-]{display:inline-block}[class*=am-icon-]:before{display:inline-block;font:normal normal normal 1.6rem/1 FontAwesome,sans-serif;font-size:inherit;text-rendering:auto;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-transform:translate(0);-ms-transform:translate(0);transform:translate(0)}.am-icon-qq:before{content:\"\\F1D6\"}.am-icon-wechat:before,.am-icon-weixin:before{content:\"\\F1D7\"}.am-icon-weibo:before{content:\"\\F18A\"}.am-icon-github:before{content:\"\\F09B\"}.am-icon-bed:before,.am-icon-hotel:before{content:\"\\F236\"}.am-icon-envelope:before{content:\"\\F0E0\"}.am-icon-linkedin:before{content:\"\\F0E1\"}.am-icon-twitter-square:before{content:\"\\F081\"}.am-icon-facebook-square:before{content:\"\\F082\"}.am-icon-twitter:before{content:\"\\F099\"}.am-icon-facebook-f:before,.am-icon-facebook:before{content:\"\\F09A\"}.am-icon-google-plus-square:before{content:\"\\F0D4\"}.am-icon-google-plus:before{content:\"\\F0D5\"}.am-icon-btn{-webkit-box-sizing:border-box;box-sizing:border-box;display:inline-block;width:48px;height:48px;font-size:24px;line-height:48px;border-radius:50%;background-color:#eee;color:#555;text-align:center}.am-icon-btn.am-danger,.am-icon-btn.am-primary,.am-icon-btn.am-secondary,.am-icon-btn.am-success,.am-icon-btn.am-warning{color:#fff}.am-icon-btn.am-primary{background-color:#0e90d2}.am-icon-btn.am-secondary{background-color:#3bb4f2}.am-icon-btn.am-success{background-color:#5eb95e}.am-icon-btn.am-warning{background-color:#f37b1d}.am-icon-btn.am-danger{background-color:#dd514c}.am-icon-btn-sm{width:32px;height:32px;font-size:16px;line-height:32px}.am-icon-btn-lg{width:64px;height:64px;font-size:28px;line-height:64px}.static{position:fixed}#staticLogo{top:0;left:0;width:100%;max-height:100px;z-index:100;overflow:visible}#staticLogo .theoneLogo{-webkit-transition:all .7s ease-out;-moz-transition:all .7s ease-out;-o-transition:all .7s ease-out;transition:all .7s ease-out;transform-origin:0 0;-webkit-transform-origin:0 0;-moz-transform-origin:0 0;-o-transform-origin:0 0}#staticLogo.active .theoneLogo{-webkit-transform:scale(.5);-moz-transform:scale(.5);-ms-transform:scale(.5);transform:scale(.5)}#tree{z-index:99;top:0;left:50%;width:50%;height:100%;overflow:visible;position:absolute}.bg-purple{background:#563d7c}.bg-leaf-green{background:#5cb85c}.bg-sky-blue{background:#5bc0de}.bg-origin{background:#f0ad4e}#sectionAll{color:#cdbfe3}#sectionAll .svgimg{height:66px;max-height:200px;width:100%;padding:10px}.section{padding-top:60px}.firstPage{padding-top:100px}#sectionInfo{color:#fff}.imgsContainer{margin-top:50px;height:400px;width:400px}.imgsContainer .svgimg{width:100px;height:100px}#sectionInfo li{padding:5px;font-size:120%}#sectionInfo p span{font-size:80%}.dl-horizontal-forever dt{clear:left;float:left;overflow:hidden;text-align:right;text-overflow:ellipsis;white-space:nowrap;width:60px}.dl-horizontal-forever dd{margin-left:80px}#resume{color:#cce9cc}.vertical-center{top:50%;margin-top:-150px}#resume .welcome,.vertical-center{position:absolute;height:300px;width:100%;overflow:hidden}#resume .welcome{top:0;z-index:10}#contact{color:#fbe6c8}#contact .vertical-center{margin-top:-200px;height:400px}#contact .vertical-center pre{font-size:80%;opacity:.8}@media screen and (max-width:767px){#staticLogo .theoneLogo{-webkit-transform:scale(.5);-moz-transform:scale(.5);-ms-transform:scale(.5);transform:scale(.5)}#staticLogo.active .theoneLogo{-webkit-transform:scale(.3);-moz-transform:scale(.3);-ms-transform:scale(.3);transform:scale(.3)}#sectionAll .svgimg{padding:0}#sectionAll h2{font-size:24px}.firstPage{padding-top:60px}.section{padding-top:30px}#resume .welcome{margin-left:-10%;padding:15px;width:115%}#resume .welcome img{transform-origin:0 0;-webkit-transform-origin:0 0;-moz-transform-origin:0 0;-o-transform-origin:0 0;-webkit-transform:scale(.7);-moz-transform:scale(.7);-ms-transform:scale(.7);transform:scale(.7)}.am-icon-btn{width:40px;height:40px;font-size:20px;line-height:40px}#contact .vertical-center{z-index:99}#tree{left:0;width:100%}}.animated{-webkit-transition:all 1s ease-out;-moz-transition:all 1s ease-out;-o-transition:all 1s ease-out;transition:all 1s ease-out}.animated.infinite{-webkit-animation-iteration-count:infinite;-moz-animation-iteration-count:infinite;-o-animation-iteration-count:infinite;animation-iteration-count:infinite}.animated.hinge{-webkit-animation-duration:2s;-moz-animation-duration:2s;-o-animation-duration:2s;animation-duration:2s}.animated.long{-webkit-animation-duration:3.5s;-moz-animation-duration:3.5s;-o-animation-duration:3.5s;animation-duration:3.5s}.moveDown{-webkit-transform:translate3d(0,200%,0);-moz-transform:translate3d(0,200%,0);-ms-transform:translate3d(0,200%,0);transform:translate3d(0,200%,0)}.moveUp{-webkit-transform:translate3d(0,-200%,0);-moz-transform:translate3d(0,-200%,0);-ms-transform:translate3d(0,-200%,0);transform:translate3d(0,-200%,0)}.moveRight{-webkit-transform:translate3d(200%,0,0);-moz-transform:translate3d(200%,0,0);-ms-transform:translate3d(200%,0,0);transform:translate3d(200%,0,0)}.moveLeft{-webkit-transform:translate3d(-200%,0,0);-moz-transform:translate3d(-200%,0,0);-ms-transform:translate3d(-200%,0,0);transform:translate3d(-200%,0,0)}.moveDownLeft{-webkit-transform:translate3d(-200%,200%,0);-moz-transform:translate3d(-200%,200%,0);-ms-transform:translate3d(-200%,200%,0);transform:translate3d(-200%,200%,0)}.moveUpLeft{-webkit-transform:translate3d(-200%,-200%,0);-moz-transform:translate3d(-200%,-200%,0);-ms-transform:translate3d(-200%,-200%,0);transform:translate3d(-200%,-200%,0)}.moveDownRight{-webkit-transform:translate3d(200%,200%,0);-moz-transform:translate3d(200%,200%,0);-ms-transform:translate3d(200%,200%,0);transform:translate3d(200%,200%,0)}.moveUpRight{-webkit-transform:translate3d(200%,-200%,0);-moz-transform:translate3d(200%,-200%,0);-ms-transform:translate3d(200%,-200%,0);transform:translate3d(200%,-200%,0)}@-webkit-keyframes flashAndtada{0%,25%,50%{opacity:1}15%,35%{opacity:0}51%{-webkit-transform:scaleX(1);-moz-transform:scaleX(1);-ms-transform:scaleX(1);transform:scaleX(1)}55%,60%{-webkit-transform:scale3d(.9,.9,.9) rotate(-3deg);-moz-transform:scale3d(.9,.9,.9) rotate(-3deg);-ms-transform:scale3d(.9,.9,.9) rotate(-3deg);transform:scale3d(.9,.9,.9) rotate(-3deg)}65%,75%,85%,95%{-webkit-transform:scale3d(1.1,1.1,1.1) rotate(3deg);-moz-transform:scale3d(1.1,1.1,1.1) rotate(3deg);-ms-transform:scale3d(1.1,1.1,1.1) rotate(3deg);transform:scale3d(1.1,1.1,1.1) rotate(3deg)}70%,80%,90%{-webkit-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);-moz-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);-ms-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);transform:scale3d(1.1,1.1,1.1) rotate(-3deg)}to{-webkit-transform:scaleX(1);-moz-transform:scaleX(1);-ms-transform:scaleX(1);transform:scaleX(1)}}@keyframes flashAndtada{0%,25%,50%{opacity:1}15%,35%{opacity:0}55%{-webkit-transform:scaleX(1);-moz-transform:scaleX(1);-ms-transform:scaleX(1);transform:scaleX(1)}58%,60%{-webkit-transform:scale3d(.9,.9,.9) rotate(-3deg);-moz-transform:scale3d(.9,.9,.9) rotate(-3deg);-ms-transform:scale3d(.9,.9,.9) rotate(-3deg);transform:scale3d(.9,.9,.9) rotate(-3deg)}65%,75%,85%,95%{-webkit-transform:scale3d(1.1,1.1,1.1) rotate(3deg);-moz-transform:scale3d(1.1,1.1,1.1) rotate(3deg);-ms-transform:scale3d(1.1,1.1,1.1) rotate(3deg);transform:scale3d(1.1,1.1,1.1) rotate(3deg)}70%,80%,90%{-webkit-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);-moz-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);-ms-transform:scale3d(1.1,1.1,1.1) rotate(-3deg);transform:scale3d(1.1,1.1,1.1) rotate(-3deg)}to{-webkit-transform:scaleX(1);-moz-transform:scaleX(1);-ms-transform:scaleX(1);transform:scaleX(1)}}.flashAndtada{-webkit-animation-name:flashAndtada;-moz-animation-name:flashAndtada;-ms-animation-name:flashAndtada;animation-name:flashAndtada}.welcome-animate-top{-webkit-transform:translate3d(175px,-300px,0);-moz-transform:translate3d(175px,-300px,0);-ms-transform:translate3d(175px,-300px,0);transform:translate3d(175px,-300px,0)}.welcome-animate-bottom{-webkit-transform:translate3d(-175px,300px,0);-moz-transform:translate3d(-175px,300px,0);-ms-transform:translate3d(-175px,300px,0);transform:translate3d(-175px,300px,0)}.delay-1s{-webkit-animation-delay:1s;-moz-animation-delay:1s;-o-animation-delay:1s;animation-delay:1s}.delay-2s{-webkit-animation-delay:2s;-moz-animation-delay:2s;-o-animation-delay:2s;animation-delay:2s}.delay-3s{-webkit-animation-delay:3s;-moz-animation-delay:3s;-o-animation-delay:3s;animation-delay:3s}.delay-4s{-webkit-animation-delay:4s;-moz-animation-delay:4s;-o-animation-delay:4s;animation-delay:4s}pre.prettyprint{display:block;background-color:#333}pre .nocode{background-color:none;color:#000}pre .str{color:#ffa0a0}pre .kwd{color:khaki;font-weight:700}pre .com{color:#87ceeb}pre .typ{color:#98fb98}pre .lit{color:#cd5c5c}pre .pln,pre .pun{color:#fff}pre .tag{color:khaki;font-weight:700}pre .atn{color:#bdb76b;font-weight:700}pre .atv{color:#ffa0a0}pre .dec{color:#98fb98}ol.linenums{margin-top:0;margin-bottom:0;color:#aeaeae}@media print{pre.prettyprint{background-color:none}code .str,pre .str{color:#060}code .kwd,pre .kwd{color:#006;font-weight:700}code .com,pre .com{color:#600;font-style:italic}code .typ,pre .typ{color:#404;font-weight:700}code .lit,pre .lit{color:#044}code .pun,pre .pun{color:#440}code .pln,pre .pln{color:#000}code .tag,pre .tag{color:#006;font-weight:700}code .atn,pre .atn{color:#404}code .atv,pre .atv{color:#060}}", ""]);
...
//# sourceMappingURL=bundle.7356d06b1ddfb41217f9.js.map